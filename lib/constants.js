...
import carbonConfig from './carbon-config.json'
...
// 页面默认设置。唯一来源是 lib/carbon-config.json（从 Settings → Misc
// → Export config 导出）。想调整默认外观时只需修改那个 JSON 文件。
...
// lib/carbon-config.json 是唯一的默认配置，同时作为预设面板中唯一的预设。
// 用户仍可在面板中创建自己的预设（存放在浏览器 localStorage）。
export const DEFAULT_PRESETS = [
  {
    ...carbonConfig,
    icon: '/static/presets/carbon-config.png',
    id: 'preset:carbon-config',
  },
]
