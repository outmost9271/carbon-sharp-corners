...
const en = {
  ...
  // Language names that read better in the UI language
  'language.auto': 'Auto',
  'language.plainText': 'Plain Text',

  // Highlight keys (theme editor)
...
const zh = {
  ...
  // Highlight keys (theme editor)
  'highlight.background': '背景',
  'highlight.text': '文本',
  'highlight.variable': '变量',
  'highlight.attribute': '属性',
  'highlight.definition': '定义',
  'highlight.keyword': '关键字',
  'highlight.operator': '运算符',
  'highlight.property': '属性名',
  'highlight.number': '数字',
